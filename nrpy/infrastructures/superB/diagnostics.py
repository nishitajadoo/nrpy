...
from nrpy.infrastructures.superB.nrpyelliptic.conformally_flat_C_codegen_library import register_CFunction_compute_L2_norm_of_gridfunction_between_r1_r2
...
def register_CFunction_diagnostics(
    ...
    if enable_L2norm_BSSN_constraints_diagnostics:
        register_CFunction_compute_L2_norm_of_gridfunction_between_r1_r2(CoordSystem=CoordSystem)
...
if (which_output == OUTPUT_PSI4) {
  ...
  REAL localsums[4];
  compute_L2_norm_of_gridfunction_between_r1_r2(commondata, griddata_chare, integration_radius1, integration_radius2, HGF, diagnostic_output_gfs, &localsums[0]);              
  compute_L2_norm_of_gridfunction_between_r1_r2(commondata, griddata_chare, integration_radius1, integration_radius2, MSQUAREDGF, diagnostic_output_gfs, &localsums[2]);
}
"""
    body += r"""else {
